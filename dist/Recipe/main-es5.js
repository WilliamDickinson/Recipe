...
var CreaterecipeComponent = /** @class */ (function () {
    ...
    //!!!
    CreaterecipeComponent.prototype.testThing = function () {
        console.log(this.timers);
    };
    CreaterecipeComponent.prototype.updateTimers = function (timers) {
...
var Instruction = /** @class */ (function () {
    function Instruction(description, option, duration, timerarray) {
